        ...
        value: function renderColumnsDropdown(columns) {
            ...
            return treeMap(columns, function (originColumn, i) {
                ...
                if (column.filters && column.filters.length > 0 || column.filterDropdown) {
                    ...
                    filterDropdown = React.createElement(FilterDropdown, { locale: locale, column: column, selectedKeys: colFilters, confirmFilter: _this7.handleFilter, prefixCls: prefixCls + '-filter', dropdownPrefixCls: dropdownPrefixCls || 'antd-v2-dropdown', getPopupContainer: _this7.getPopupContainer });
                }
                if (column.sorter) {
