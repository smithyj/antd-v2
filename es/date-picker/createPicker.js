    ...
    return _a = function (_React$Component) {
        ...
        _createClass(CalenderWrapper, [{
            ...
            value: function render() {
                ...
                if (props.showTime) {
                    calendarHandler = {
                        // fix https://github.com/antd-v2-design/antd-v2-design/issues/1902
                ...
                return React.createElement(
                    'span',
                    { className: classNames(props.className, props.pickerClass), style: style },
                    React.createElement(
                        RcDatePicker,
                        _extends({}, props, pickerChangeHandler, { calendar: calendar, value: value, prefixCls: prefixCls + '-picker-container', style: props.popupStyle }),
                        input
                    )
                );
            }
