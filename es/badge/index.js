...
var Badge = function (_React$Component) {
    ...
    _createClass(Badge, [{
        ...
        value: function render() {
            ...
            var scrollNumber = hidden ? null : React.createElement(ScrollNumber, { prefixCls: scrollNumberPrefixCls, 'data-show': !hidden, className: scrollNumberCls, count: displayCount, title: count, style: style });
...
Badge.defaultProps = {
    prefixCls: 'antd-v2-badge',
    scrollNumberPrefixCls: 'antd-v2-scroll-number',
    count: null,
    showZero: false,
    dot: false,
    overflowCount: 99
