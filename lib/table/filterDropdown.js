...
var FilterMenu = function (_React$Component) {
    ...
    function FilterMenu(props) {
        ...
        _this.setNeverShown = function (column) {
            ...
            var filterBelongToScrollBody = !!(0, _domClosest2['default'])(rootNode, '.antd-v2-table-scroll');
            if (filterBelongToScrollBody) {
                // When fixed column have filters, there will be two dropdown menus
                // Filter dropdown menu inside scroll body should never be shown
                // To fix https://github.com/antd-v2-design/antd-v2-design/issues/5010 and
                // https://github.com/antd-v2-design/antd-v2-design/issues/7909
