        ...
        value: function renderColumnsDropdown(columns) {
            ...
            return (0, _util.treeMap)(columns, function (originColumn, i) {
                ...
                if (column.filters && column.filters.length > 0 || column.filterDropdown) {
                    ...
                    filterDropdown = _react2['default'].createElement(_filterDropdown2['default'], { locale: locale, column: column, selectedKeys: colFilters, confirmFilter: _this7.handleFilter, prefixCls: prefixCls + '-filter', dropdownPrefixCls: dropdownPrefixCls || 'antd-v2-dropdown', getPopupContainer: _this7.getPopupContainer });
                }
                if (column.sorter) {
